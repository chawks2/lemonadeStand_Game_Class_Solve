...
class ViewController: UIViewController {
    ...
    @IBAction func purchaseIceCubeButtonPressed(sender: UIButton) {
        ...
        if supplies.money >= price.iceCube {
            ...
            showAlertWithText(header: "Error", message: "You do not have enough money!")
        }
    }
    ...
    @IBAction func startDayButtonPressed(sender: UIButton) {
        ...
        if lemonsToMix == 0 || iceCubesToMix == 0 {
            ...
            //for loop for 0 to x customers
            for x in 0...customers{
                //getting preference for customers out of 101 possible randoms
